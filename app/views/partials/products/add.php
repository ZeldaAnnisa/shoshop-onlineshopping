                            ...
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="sale_price">Sale Price <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-sale_price"  value="<?php  echo $this->set_field_value('sale_price',""); ?>" type="number" placeholder="Enter Sale Price" step="0.1"  required="" name="sale_price"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="stock_status">Stock Status <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-stock_status"  value="<?php  echo $this->set_field_value('stock_status',""); ?>" type="text" placeholder="Enter Stock Status"  required="" name="stock_status"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-quantity"  value="<?php  echo $this->set_field_value('quantity',"10"); ?>" type="number" placeholder="Enter Quantity" step="1"  required="" name="quantity"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
