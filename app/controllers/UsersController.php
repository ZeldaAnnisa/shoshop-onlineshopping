...
class UsersController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				users.two_factor_secret LIKE ? OR 
				users.two_factor_recovery_codes LIKE ? OR 
				users.remember_token LIKE ? OR 
				users.current_team_id LIKE ? OR 
				users.profile_photo_path LIKE ? OR 
				users.utype LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("username","name","email","email_verified_at","password","two_factor_secret","two_factor_recovery_codes","remember_token","current_team_id","profile_photo_path","utype","created_at","updated_at");
			...
			$this->sanitize_array = array(
				...
				'two_factor_secret' => 'sanitize_string',
				'two_factor_recovery_codes' => 'sanitize_string',
				'remember_token' => 'sanitize_string',
				'current_team_id' => 'sanitize_string',
				'profile_photo_path' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","username","name","email_verified_at","two_factor_secret","two_factor_recovery_codes","remember_token","current_team_id","profile_photo_path","utype","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'username' => 'required',
