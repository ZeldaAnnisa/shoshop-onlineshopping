...
class ProductsController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				products.sale_price LIKE ? OR 
				products.stock_status LIKE ?
			)";
			$search_params = array(
				"%$text%","%$text%","%$text%","%$text%"
			);
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("title","description","sale_price","stock_status","quantity","category_id","user_id");
			...
			$this->sanitize_array = array(
				...
				'sale_price' => 'sanitize_string',
				'stock_status' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","title","description","sale_price","stock_status","quantity","category_id","user_id");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'title' => 'required',
