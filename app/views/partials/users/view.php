                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-two_factor_secret">
                                        <th class="title"> Two Factor Secret: </th>
                                        <td class="value">
                                            <span  data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="two_factor_secret" 
                                                data-title="Enter Two Factor Secret" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="textarea" 
                                                data-mode="popover" 
                                                data-showbuttons="left" 
                                                class="is-editable" >
                                                <?php echo $data['two_factor_secret']; ?> 
                                            </span>
                                        </td>
                                    </tr>
                                    <tr  class="td-two_factor_recovery_codes">
                                        <th class="title"> Two Factor Recovery Codes: </th>
                                        <td class="value">
                                            <span  data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="two_factor_recovery_codes" 
                                                data-title="Enter Two Factor Recovery Codes" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="textarea" 
                                                data-mode="popover" 
                                                data-showbuttons="left" 
                                                class="is-editable" >
                                                <?php echo $data['two_factor_recovery_codes']; ?> 
                                            </span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr  class="td-current_team_id">
                                        <th class="title"> Current Team Id: </th>
                                        <td class="value">
                                            <span  data-value="<?php echo $data['current_team_id']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="current_team_id" 
                                                data-title="Enter Current Team Id" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="number" 
                                                data-mode="popover" 
